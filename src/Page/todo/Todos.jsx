...
const Todos = () => {
  ...
  useEffect(()=>{
    setContext({ appTitle: 'Todos', breadcrumbs:[{label : TASKS}], activeMenu : TASKS})
  },[])
          ...
          <Grid item xs={12} sm={6} md={4} key={item.id}>
            <Card sx={{ minWidth: 275 }}>
              <CardContent>
                ...
                <Typography variant="body2">Status : <h3>{item.completed ? "Completed" : "Not Completed"}</h3></Typography>
              </CardContent>
              <CardActions>
